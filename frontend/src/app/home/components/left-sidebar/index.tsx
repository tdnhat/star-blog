...
import { Home, Tag, Bookmark, Lightbulb, FileText, Shield, FileCheck } from 'lucide-react'
...
const LeftSidebar = () => {
  ...
  const otherLinks = [
    { icon: <FileText size={18} />, text: 'Code of Conduct', path: '/code-of-conduct' },
    { icon: <Shield size={18} />, text: 'Privacy Policy', path: '/privacy' },
    { icon: <FileCheck size={18} />, text: 'Terms of Service', path: '/terms' },
  ]

  return (
    <aside className="hidden lg:flex flex-col w-64 h-screen sticky top-0 pt-4 px-2 bg-base-100">
      {/* Main Navigation */}
